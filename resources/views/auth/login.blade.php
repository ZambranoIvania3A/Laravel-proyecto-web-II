          ...
          <div class="row g-0">
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">Bienvenido a la Plataforma de Gestión de Talento Humano de la Universidad Laica «Eloy Alfaro» de Manabí – ULEAM.</h4>
                <p class="small mb-0">¡Nos alegra tenerte aquí! Este portal ha sido diseñado para facilitar la administración y el desarrollo de nuestro talento humano. Aquí podrás acceder a diversas funcionalidades que te ayudarán a gestionar tu información personal y a conectarte con nuestros recursos</p>
              </div>
            </div>
          </div>
        </div>
